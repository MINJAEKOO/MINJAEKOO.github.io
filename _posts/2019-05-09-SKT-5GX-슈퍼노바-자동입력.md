...
<div markdown="0"><a href="#" class="btn btn-danger">본 자료는 교육용도로만 제작되었음을 알려드립니다.</a></div>
<div markdown="0"><a href="#" class="btn btn-danger">악용으로 인한 불이익은 절대 책임지지 않습니다.</a></div>


# Python을 이용해서 이벤트를 자동응모해보자.

<figure>
	<a href="http://www.ddforensic.com/image/test.png">
  <img src="http://www.ddforensic.com/image/test.png"></a>
</figure>


사용한 프로그램은 다음과 같다.
- Python 3.7
- Google Chromedriver.exe
